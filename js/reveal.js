...
(function( root, factory ) {
	...
	function loadScript( url, callback ) {
		...
		if( callback ) {
			...
			script.onerror = function( err ) {
				...
				callback( new Error( 'Nieudane ładowanie skryptu: ' + script.src + '\n' + err) );
	...
	function setupDOM() {
		...
		dom.controls = createSingletonNode( dom.wrapper, 'aside', 'controls',
			'<button class="navigate-left" aria-label="poprzedni slajd"><div class="controls-arrow"></div></button>' +
			'<button class="navigate-right" aria-label="następny slajd"><div class="controls-arrow"></div></button>' +
			'<button class="navigate-up" aria-label="slajd powyżej"><div class="controls-arrow"></div></button>' +
			'<button class="navigate-down" aria-label="slajd poniżej"><div class="controls-arrow"></div></button>' );
		...
		dom.pauseOverlay = createSingletonNode( dom.wrapper, 'div', 'pause-overlay', config.controls ? '<button class="resume-button">Wznowienie prezentacji</button>' : null );
	...
	function configure( options ) {
		...
		if( config.navigationMode === 'linear' ) {
			...
			keyboardShortcuts['N  ,  SPACE']   = 'Następny slajd';
			keyboardShortcuts['P']             = 'Poprzedni slajd';
			keyboardShortcuts['&#8592;  ,  H'] = 'Nawiguj w lewo';
			keyboardShortcuts['&#8594;  ,  L'] = 'Nawiguj w prawo';
			keyboardShortcuts['&#8593;  ,  K'] = 'Nawiguj w górę';
			keyboardShortcuts['&#8595;  ,  J'] = 'Nawiguj w dół';
		}

		keyboardShortcuts['Home  ,  &#8984;/CTRL &#8592;'] = 'Pierwszy slajd';
		keyboardShortcuts['End  ,  &#8984;/CTRL &#8594;']  = 'Ostatni slajd';
		keyboardShortcuts['B  ,  .']                       = 'Pauza';
		keyboardShortcuts['F']                             = 'Pelny ekran';
		keyboardShortcuts['ESC, O']                        = 'Przegląd slajdów';
		...
		dom.overlay.innerHTML = [
			...
			'<div class="viewport">',
				...
				'<small class="viewport-inner">',
					'<span class="x-frame-error">Nie można załadować ramy iframe. Jest to prawdopodobnie spowodowane zasadami strony (x-frame-options).</span>',
				'</small>',
			'</div>'
		].join('');
	...
	function showHelp() {
		...
		if( config.help ) {
			...
			var html = '<p class="title">Króty klawiaturowe</p><br/>';

			html += '<table><th>KEY</th><th>AKCJA</th>';
	...
	function updateNotes() {
		...
		if( config.showNotes && dom.speakerNotes && currentSlide && !isPrintingPDF() ) {
			...
			dom.speakerNotes.innerHTML = getSlideNotes() || '<span class="notes-placeholder">Brak notatek do tego slajdu.</span>';
